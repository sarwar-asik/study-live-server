...
/**
 * @generated from message livekit.ListAgentDispatchRequesst
 */
export declare class ListAgentDispatchRequesst extends Message<ListAgentDispatchRequesst> {
  /**
  ...
  constructor(data?: PartialMessage<ListAgentDispatchRequesst>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.ListAgentDispatchRequesst";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ListAgentDispatchRequesst;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ListAgentDispatchRequesst;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ListAgentDispatchRequesst;

  static equals(a: ListAgentDispatchRequesst | PlainMessage<ListAgentDispatchRequesst> | undefined, b: ListAgentDispatchRequesst | PlainMessage<ListAgentDispatchRequesst> | undefined): boolean;
}
