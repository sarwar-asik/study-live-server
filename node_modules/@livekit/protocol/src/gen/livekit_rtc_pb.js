...
export const ErrorResponse = /*@__PURE__*/ proto3.makeMessageType(
  "livekit.ErrorResponse",
  () => [
    { no: 1, name: "request_id", kind: "scalar", T: 13 /* ScalarType.UINT32 */ },
    { no: 2, name: "reason", kind: "enum", T: proto3.getEnumType(ErrorResponse_Reason) },
 ...
 */
export const ErrorResponse_Reason = /*@__PURE__*/ proto3.makeEnum(
  "livekit.ErrorResponse.Reason",
  [
    {no: 0, name: "UNKNOWN"},
    {no: 1, name: "NOT_FOUND"},
