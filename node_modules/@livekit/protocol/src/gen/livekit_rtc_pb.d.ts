...
export declare class SignalResponse extends Message<SignalResponse> {
  ...
  message: {
     ...
     *
     * @generated from field: livekit.ErrorResponse error_response = 22;
     */
    value: ErrorResponse;
    case: "errorResponse";
  } | {
...
export declare class ErrorResponse extends Message<ErrorResponse> {
  ...
  /**
   * @generated from field: livekit.ErrorResponse.Reason reason = 2;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "livekit.ErrorResponse";
  static readonly fields: FieldList;
 ...
 */
export declare enum ErrorResponse_Reason {
  /**
